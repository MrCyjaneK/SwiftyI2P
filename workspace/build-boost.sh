...
downloadBoost()
{
    if [ $(version $BOOST_VERSION) -ge $(version "1.63.0") ]; then
        DOWNLOAD_SRC=https://archives.boost.io/release/${BOOST_VERSION}/source/boost_${BOOST_VERSION2}.tar.bz2
    else
...
# BUILD_VARIANT is like 'release' or 'debug'
...
downloadBoost
verifyBoost "$BOOST_SHA" "$BOOST_TARBALL"
unpackBoost
inventMissingHeaders
...
echo "Boost completed successfully"
